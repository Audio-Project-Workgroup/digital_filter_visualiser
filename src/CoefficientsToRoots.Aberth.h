...
private:
    ...
    static c_vector p_of_rn(const vector& polynomial, const c_vector& guesses);
    ...
    static void update_guesses_schroder(const vector& polynomial, const vector& derivative, const vector& second_derivative, const c_vector& previous_guesses, c_vector& new_guesses);
